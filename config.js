...
const startupChannel = "somalipiratebot";
...
const onlinePrintChannel = "somalipiratebot";
...
const modChannels = ["echoflex", "somalipiratebot"];
...
let enabledChannels = {
  echoflex: {
    ...
    protection: {
      endpoint: "https://echoflex.feelsokaybot.com/api/v1/banphrases/test",
